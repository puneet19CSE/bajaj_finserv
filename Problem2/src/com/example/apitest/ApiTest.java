...
public class ApiTest {
    ...
    private static void testCreateUser(String rollNumber, String firstName, String lastName, String phoneNumber, String emailId) {
        ...
        try {
            ...
            System.out.println("Request Payload: " + jsonInputString); // Debugging line
            ...
            try (BufferedReader in = new BufferedReader(new InputStreamReader(conn.getInputStream()))) {
                ...
                // Read error stream for non-200 responses
                if (conn.getErrorStream() != null) {
                    ...
                    System.out.println("Error: Unable to read error stream.");
                }
            }
